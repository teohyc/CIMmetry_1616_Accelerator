...
### 3. The Models 
* **Siamese Network (CNN):** A custom 128 parameters TinyML edge facial-recognition model. Quantization-Aware-Trained (int8) via contrastive loss and 50 data for the 2 face classes.
