...
input_dir = "steve_8x8_processed"
tensors = []

for i in range(1, 5):
    filepath = os.path.join(input_dir, f"steve{i}_8x8.png")
...
steve_data = torch.stack(tensors).to(device)
print(f"Successfully loaded 4 images. Batch shape: {steve_data.shape}")
...
output_path = "generated_steve_experiment.png"
output_img.save(output_path)

print(f"Result at {output_path}")

#save model
torch.save(model.state_dict(), "steve_DiT.pth")
